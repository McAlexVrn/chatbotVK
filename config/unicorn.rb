deploy_to  = "/home/deployer/chatbot"
rails_root = "/home/deployer/chatbot/"
...
listen "/tmp/unicorn.chatbot.sock"
pid pid_file
stderr_path err_log
...
#kill -QUIT `cat "/home/deployer/chatbot/shared/pids/unicorn.pid"`
#bundle exec unicorn -c /home/deployer/chatbot/config/unicorn.rb -E production -D